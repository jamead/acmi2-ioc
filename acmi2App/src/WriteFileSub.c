...
int WriteFileSub(aSubRecord *precord) {
    ...
    Set[12] = TP1[5];	strcpy(names[12],"TP1 Integral High Level");
    Set[13] = TP1[6];	strcpy(names[13],"TP1 Integral Low Level");
    Set[14] = TP2[5];	strcpy(names[14],"TP2 Integral High Level");
    Set[15] = TP2[6];	strcpy(names[15],"TP2 Integral Low Level");
    Set[16] = TP3[5];	strcpy(names[16],"TP3 Integral High Level");
    Set[17] = TP3[6];	strcpy(names[17],"TP3 Integral Low Level");
    Set[18] = TP1[7];	strcpy(names[18],"TP1 Peak High Level");
    Set[19] = TP1[8];	strcpy(names[19],"TP1 Peak Low Level");
    Set[20] = TP2[7];	strcpy(names[20],"TP2 Peak High Level");
    Set[21] = TP2[8];	strcpy(names[21],"TP2 Peak Low Level");
    Set[22] = TP3[7];	strcpy(names[22],"TP3 Peak High Level");
    Set[23] = TP3[8];	strcpy(names[23],"TP3 Peak Low Level");
    Set[24] = TP1[9];	strcpy(names[24],"TP1 FWHM High Level");
    Set[25] = TP1[10];	strcpy(names[25],"TP1 FWHM Low Level");
    Set[26] = TP2[9];	strcpy(names[26],"TP2 FWHM High Level");
    Set[27] = TP2[10];	strcpy(names[27],"TP2 FWHM Low Level");
    Set[28] = TP3[9];	strcpy(names[28],"TP3 FWHM High Level");
    Set[29] = TP3[10];	strcpy(names[29],"TP3 FWHM Low Level");
    Set[30] = TP1[11];	strcpy(names[30],"TP1 Baseline High Level");
    Set[31] = TP1[12];	strcpy(names[31],"TP1 Baseline Low Level");
    Set[32] = TP2[11];	strcpy(names[32],"TP2 Baseline High Level");
    Set[33] = TP2[12];	strcpy(names[33],"TP2 Baseline Low Level");
    Set[34] = TP3[11];	strcpy(names[34],"TP3 Baseline High Level");
    Set[35] = TP3[12];	strcpy(names[35],"TP3 Baseline Low Level");
    Set[36] = TP1[3];	strcpy(names[36],"TP1 Negative Level");
    Set[37] = TP2[3];	strcpy(names[37],"TP2 Negative Level");
    Set[38] = TP3[3];	strcpy(names[38],"TP3 Negative Level");
    Set[39] = TP1[2];	strcpy(names[39],"TP1 Positive Level");
    Set[40] = TP2[2];	strcpy(names[40],"TP2 Positive Level");
    Set[41] = TP3[2];	strcpy(names[41],"TP3 Positive Level");
